...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(pendel.v6keperiood());
        ...
        System.out.println("1 hammastratta suurus: " + hammasratas1.suurus);
        System.out.println("2 hammastratta suurus: " + hammasratas2.suurus);
        System.out.println("3 hammastratta suurus: " + hammasratas3.suurus);
        System.out.printf("Minu kella suurus: %.2f" , (pendliPikkus + hammasratas1.suurus + hammasratas2.suurus + hammasratas3.suurus));

        while (true){
            TimeUnit.MILLISECONDS.sleep((long) (pendel.v6keperiood()*1000)/2);
            if (isLeft){
